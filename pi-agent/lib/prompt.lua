...
function prompt.build(options)
    ...
    addGuideline("Call tools directly. Do not attempt to create complex Lua scripts, loops, or logic to manage tool outputs. Call the tool, let the system return the result, and then react to that la result, and then react to that result in your next message.")
